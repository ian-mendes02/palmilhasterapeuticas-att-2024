 ...
 * @param {string} props.className 
 * @param {null|import('react').StyleHTMLAttributes<HTMLImageElement>} props.style 
 */
export function Img( {src = '', width = '', height = '', className = '', style = {}} ) {
    return <img src={source( src )} alt="" draggable="false" width={width} height={height} className={className} style={style} />;
}